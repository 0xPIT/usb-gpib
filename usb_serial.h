/* USB Serial code for Teensy USB Development Board
...
int8_t usb_serial_puts(const char *);
int8_t usb_serial_puts_P(const char *);
...
class UsbSerial:public Formatting<UsbSerial>
{
public:
   ...
   {
      // wait forever
      while(int8_t r=usb_serial_putchar(c))
         if(r==-9)
            return;
   }
